							...
							<tr>
								<th colspan="5">
									...
									<s:if test="#order.state==1">
										<a href="order_findByOid.action?oid=<s:property value="#order.oid"/>"><font color="red">待付款</font></a>
									</s:if>
									<s:if test="#order.state==2">
										<font color="red">待发货</font>
									</s:if>
									<s:if test="#order.state==3">
										<a href="order_updateState.action?oid=<s:property value="#order.oid"/>" style="color: blue;text-decoration: underline;"><font color="blue">确认收货</font></a>
									</s:if>
									<s:if test="#order.state==4">
										<font color="green">交易完成</font>
									</s:if>
									&nbsp;&nbsp;&nbsp;&nbsp;
									<a href="order_delete.action?oid=<s:property value="#order.oid"/>">
